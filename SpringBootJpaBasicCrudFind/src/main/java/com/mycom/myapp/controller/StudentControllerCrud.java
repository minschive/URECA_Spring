...
// return type 이 Student ( Entity ) 인데, StudentDto 를 사용하는 게 바람직하다. 단순화하기 위한 코드
@RestController
...
public class StudentControllerCrud {
    ...
    @GetMapping("/page")
    public List<Student> listStudent(@RequestParam("pageNumber") Integer pageNumber, @RequestParam("pageSize") Integer pageSize) {
