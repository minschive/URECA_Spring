...
<script>
    ...
    window.onload = function(){
        ...
        document.querySelector("#btnBoardUpdateForm").onclick = function () {
            // 상세 모달의 data-bookId 을 글 수정 모달의 data-boardId 복사
            ...
            // 상세의 글 제목, 내용을 수정 모달의 input 의 value 로 (내가 쓴 글이므로)
            ...
            // 수정 모달 show 상세 모달 hide (data-disimss 처리도 자동으로 close)
...
//              console.log(regDt);
    ...
    async function updateBoard(){ // boardId 전송 필요
    ...
    async function deleteBoard(){ // boardId 전송 필요, 나머지 데이터 필요 X, get
