...
//      2. ResultDto 를 Client 에게 전달을 하는데 사용 X, 대신 Controller 에서 Service 에서 return 한 ResultDto 객체를 이용해서
...
public class StudentControllerCrudJsonRequestRE {
    ...
    public ResponseEntity<StudentResultDto> listStudent() {
        ...
        // 오류 있으면 ResultDto body 추가 X, 에러 코드
        // client 는 try-catch
...
//        return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
        ...
        // 200 OK 로 status 코드를 보내도, body 에 데이터 X -> try-catch 에서 예외 발생
...
//                .build(); // body() 없이 마무리
    ...
    public ResponseEntity<StudentResultDto> detailStudent(@PathVariable("id") Integer id) {
        ...
        // ResponseEntity + ResultDto 함께 사용의 #2
